    ...
    <>
      ...
      <div className="product">
        ...
        <div className="product-image">
          <figure>
            ...
            <figcaption>
              Nuraphone <br /> <strike>$399</strike> $299.25
              <br />
          ...
          <figure>
            ...
            <figcaption>
              Nura Bluetooth&reg;5.3
              <br />
              Audio Transmitter
              <br />
              <strike>$399</strike> $299.25
              <br />
              <button>shop now</button>
            </figcaption>
          </figure>
      ...
      <div className="nuratrue">
        ...
        <div className="nuradetails">
          ...
          <p>
            Normal hearing varies significantly
            <br />
            from person to person, and these variations
            <br />
      ...
      <div className="nurabackup">
        <div className="nurabackup-text">
          ...
          <p>
            ...
            , ,and is applied to whatever you
            <br />
      ...
      <div className="subscription">
        ...
        <p>
          Experience personalised sound across our devices on a <br />
      ...
      <footer>
        <div className="footer">
          <div>
            ...
            <p>
              Nura designs headphones
              <br />
              tuned to you. Bringing you
              <br />
